...
const Eachbox = ({ data }) => {
  return (
    <div className="flex flex-col items-center justify-around py-10 mb-5 drop-shadow-md shadow-black bg-gradient-to-r from-sky-400 to-blue-500 rounded-2xl w-72 h-80">
