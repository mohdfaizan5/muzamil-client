...
const HeroSection = () => {
  return (
    <main className="py-10 px-10 gap-4 h-[80vh] flex flex-col items-center justify-center bg-[] relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-32">
      ...
      <section className="z-10 flex flex-col items-start gap-6">
        ...
        <button className="btn2 group">Get In Touch {" "}<MdArrowOutward className="transition-all ease-linear group-hover:rotate-45" />
</button>
      </section>
      <section></section>
    </main>
